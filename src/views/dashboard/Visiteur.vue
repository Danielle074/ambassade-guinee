...
/* Actions */
function editEmployee(emp: Employee) { alert(`Modifier ${emp.name}`); activeMenuId.value = null; }
function deleteEmployee(emp: Employee) { alert(`Supprimer ${emp.name}`); activeMenuId.value = null; }
function addEmployee(emp: Employee) { alert(`Ajouter ${emp.name}`); activeMenuId.value = null; }
